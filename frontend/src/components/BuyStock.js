...
const BuyStock = (props) => {
  ...
  <br/>
  <input type="number" label="Quantity" id="quantity" name="quantity" min="1"  onChange={props.handleChange}/>
  <br/>
      <Button type='submit' onClick={props.handleSubmit} color="red">Buy </Button>
  </Segment>)
}
